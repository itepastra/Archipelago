...
def create_locations(world: UnfairFlipsWorld, reg: Region, region_type: str, gate_index: int):
    ...
    if region_type == "Fairness":
        if gate_index == 0:
            ...
            if head_1 < world.options.required_heads:
                ...
                location.access_rule = lambda state: can_practically_get_heads_in_a_row(world, state.count("Heads+", world.player), head_1)
            ...
            if head_2 < world.options.required_heads:
                ...
                heads_id = world.location_name_to_id[heads_name]
                location = create_location(world.player, reg, heads_name, heads_id)
                location.access_rule = lambda state: can_practically_get_heads_in_a_row(world, state.count("Heads+", world.player), head_2)
