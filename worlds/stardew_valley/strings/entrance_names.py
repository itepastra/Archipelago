...
class Entrance:
    ...
    mountain_to_carpenter_house = "Mountain to Carpenter House"
    carpenter_house_to_mountain = "Carpenter House to Mountain"
    mountain_to_maru_room = "Mountain to Maru's Room"
    maru_room_to_mountain = "Maru's Room to Mountain"
    carpenter_house_to_maru_room = "Carpenter House to Maru's Room"
    maru_room_to_carpenter_house = "Maru's Room to Carpenter House"
    ...
    town_to_blacksmith = "Town to Blacksmith"
    blacksmith_to_town = "Blacksmith to Town"
    ...
    beach_to_willy_fish_cabin = "Beach to Willy's Fish Cabin"
    willy_fish_cabin_to_beach = "Willy's Fish Cabin to Beach"
    fish_cabin_to_boat_tunnel = "Willy's Fish Cabin to Boat Tunnel"
    boat_tunnel_to_fish_cabin = "Boat Tunnel to Willy's Fish Cabin"
    ...
    enter_sebastian_room_stairwell = "Carpenter House to Sebastian's Room"
    leave_sebastian_room_stairwell = "Sebastian's Room to Carpenter House"
    ...
    volcano_to_volcano_mines = "Volcano Entrance to Volcano Mines"
    volcano_mines_to_volcano = "Volcano Mines to Volcano Entrance"
    ...
    purchase_from_pierre = "Purchase From Pierre"
    purchase_from_robin = "Purchase From Robin"
    purchase_from_clint = "Purchase From Clint"
    purchase_from_marnie = "Purchase From Marnie"
    purchase_from_gus = "Purchase From Gus"
...
@final
class LogicEntrance:
    break_dwarf_rocks = "Break Dwarf Cave Entrance"
