...
class Entrance:
    ...
    bus_stop_cutscene_to_bus_stop = "Bus Stop Cutscene to Bus Stop"
    ...
    use_farm_totem = "Use Farm Totem"
    use_desert_totem = "Use Desert Totem"
    use_beach_totem = "Use Beach Totem"
    use_mountain_totem = "Use Mountain Totem"
    use_island_totem = "Use Island Totem"
    use_return_scepter = "Use Return Scepter"
    backwoods_to_mountain = "Backwoods to Mountain"
    mountain_to_backwoods = "Mountain to Backwoods"
    bus_stop_to_town = "Bus Stop to Town"
    town_cutscene_to_town = "Town Cutscene to Town"
    ...
    enter_sebastian_room_stairwell = "Carpenter Shop to Sebastian's Room"
    leave_sebastian_room_stairwell = "Sebastian's Room to Carpenter Shop"
    enter_sebastian_room = "Enter Sebastian's Room"
    leave_sebastian_room = "Leave Sebastian's Room"
    hospital_to_hospital_back = "Hospital to Hospital Back"
    hospital_back_to_hospital = "Hospital Back to Hospital"
    ...
    dig_site_to_professor_snail_cave_entrance = "Dig Site to Professor Snail Cave Entrance"
    professor_snail_cave_entrance_to_dig_site = "Professor Snail Cave Entrance to Dig Site"
    professor_snail_cave_entrance_to_cave = "Dig Site to Professor Snail Cave"
...
class LogicEntrance:
    ...
    witch_swamp_bot_to_top = "Witch Swamp Bottom to Top"
    witch_swamp_top_to_bot = "Witch Swamp Top to Bottom"
    access_witch_swamp_from_top = "Witch Swamp Access from Top"
    access_witch_swamp_from_bot = "Witch Swamp Access from Bottom"
    mountain_shortcut_fence_entrance = "Entrance to Behind Fence In Mountains"
    mountain_shortcut_fence_exit = "Exit from Behind Fence In Mountains"
    mountain_shortcut_walkway_entrance = "Entrance to Walkway of Jojamart Shortcut"
    mountain_shortcut_walkway_exit = "Exit from Walkway of Jojamart Shortcut"
    jojamart_shortcut_cave_entrance = "Entrance to Jojamart Cave In Town"
    jojamart_shortcut_cave_exit = "Exit from Jojamart Cave In Town"
