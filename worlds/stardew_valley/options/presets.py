...
all_random_settings = {
    ...
    options.EntranceRandomizationBehaviour.internal_name:"random",
...
easy_settings = {
    ...
    options.EntranceRandomizationBehaviour.internal_name: options.EntranceRandomizationBehaviour.preset_easy,
...
hard_settings = {
    ...
    options.EntranceRandomizationBehaviour.internal_name: options.EntranceRandomizationBehaviour.preset_normal,
    options.StartWithout.internal_name:                 options.StartWithout.preset_easy,
    options.SeasonRandomization.internal_name:          options.SeasonRandomization.option_randomized,
    options.Cropsanity.internal_name:                   options.Cropsanity.option_enabled,
...
nightmare_settings = {
    ...
    options.EntranceRandomization.internal_name:        options.EntranceRandomization.option_buildings,
    options.EntranceRandomizationBehaviour.internal_name:        options.EntranceRandomizationBehaviour.preset_hard,
