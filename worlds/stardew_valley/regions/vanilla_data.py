...
vanilla_regions: tuple[RegionData, ...] = (
    ...
    RegionData(
        ...
        (
            ...
            LogicEntrance.farmhouse_upgrade_kitchen,
    ...
    RegionData(RegionName.womens_locker_room, (Entrance.leave_womens_locker_room, Entrance.womens_lockers_to_public_bath)),
    ...
    RegionData(LogicRegion.raccoon_daddy, (LogicEntrance.buy_from_raccoon_1, LogicEntrance.can_complete_raccoon_requests_1)),
    ...
    RegionData(LogicRegion.egg_festival, (LogicEntrance.purchase_from_pierre_egg_festival,)),
    RegionData(LogicRegion.egg_festival_shop),
    RegionData(LogicRegion.desert_festival),
    RegionData(LogicRegion.flower_dance, (LogicEntrance.purchase_from_pierre_flower_dance,)),
    RegionData(LogicRegion.flower_dance_shop),
    RegionData(LogicRegion.luau, (LogicEntrance.purchase_from_pierre_luau,)),
    RegionData(LogicRegion.luau_shop),
    RegionData(LogicRegion.trout_derby),
    RegionData(LogicRegion.moonlight_jellies, (LogicEntrance.purchase_from_pierre_moonlight_jellies,)),
    RegionData(LogicRegion.moonlight_jellies_shop),
    RegionData(LogicRegion.fair),
    RegionData(LogicRegion.spirit_eve, (LogicEntrance.purchase_from_pierre_spirit_eve,)),
    RegionData(LogicRegion.spirit_eve_shop),
    RegionData(LogicRegion.festival_of_ice),
    RegionData(LogicRegion.night_market),
    RegionData(LogicRegion.winter_star, (LogicEntrance.purchase_from_pierre_winter_star,)),
    RegionData(LogicRegion.winter_star_shop),
...
vanilla_connections: tuple[ConnectionData, ...] = (
    ...
    ConnectionData(LogicEntrance.fish_in_forest_river, LogicRegion.forest_river),
    ConnectionData(LogicEntrance.fish_in_forest_pond, LogicRegion.forest_pond),
    ...
    ConnectionData(LogicEntrance.purchase_from_pierre_egg_festival, LogicRegion.egg_festival_shop),
    ...
    ConnectionData(LogicEntrance.purchase_from_pierre_flower_dance, LogicRegion.flower_dance_shop),
    ConnectionData(LogicEntrance.attend_luau, LogicRegion.luau),
    ConnectionData(LogicEntrance.purchase_from_pierre_luau, LogicRegion.luau_shop),
    ...
    ConnectionData(LogicEntrance.purchase_from_pierre_moonlight_jellies, LogicRegion.moonlight_jellies_shop),
    ...
    ConnectionData(LogicEntrance.purchase_from_pierre_spirit_eve, LogicRegion.spirit_eve_shop),
    ...
    ConnectionData(LogicEntrance.purchase_from_pierre_winter_star, LogicRegion.winter_star_shop),
