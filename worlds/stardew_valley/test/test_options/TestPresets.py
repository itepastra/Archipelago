from Options import PerGameCommonOptions, OptionSet, OptionDict, Removed
...
class TestPresets(SVTestCase):
    def test_all_presets_explicitly_set_all_options(self):
        ...
        mandatory_option_names = {option_key for option_key in all_option_names
                                  ...
                                  not issubclass(StardewValleyOptions.type_hints[option_key], OptionSet | OptionDict | Removed)}
