...
from ...options import BackpackProgression, BackpackSize, BundlesPerRoom, BundlePrice, FarmType
...
extra_options_to_ignore = [BackpackProgression.internal_name, BackpackSize.internal_name, BundlesPerRoom.internal_name,
